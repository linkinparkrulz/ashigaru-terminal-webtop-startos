...
// not all possible fields of Ashigaru Terminal config are included, so
...
export type AshigaruConfigType = typeof shape._TYPE

export const ashigaru = FileHelper.json(
  '/media/startos/volumes/userdir/.ashigaru/config',
  shape,
)
